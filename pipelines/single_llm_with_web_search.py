...
class SingleLLMWithWebSearchPipeline(Pipeline):
    def __init__(
        self,
    ...
    def _make_mcp_server(self) -> MCPServerStreamableHttp:
        return CustomMCPServerStreamableHttp(
            name="web search",
            params={
            ...
            retry_backoff_seconds_base=10.0,
    ...
    async def run_pipeline(
        ...
        mcp_server = self._make_mcp_server()
