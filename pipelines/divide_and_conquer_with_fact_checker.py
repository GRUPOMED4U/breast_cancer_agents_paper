...
# Main class
class DivideAndConquerPipelineWithFactChecker(Pipeline):
    def __init__(
        self,
    ...
    async def _run_single_task(
        ...
        async with concurrency_limiter:
            run_context = PipelineRunContext(current_entry=entry)
            ...
            try:
                ...
                agent = self._make_agent(
                    tools=subagents_as_tools, handoffs=[fact_checker_handoff]
                )
                ...
                return await Runner.run(
                    ...
                    run_config=RunConfig(
                        tool_execution=ToolExecutionConfig(
                            max_function_tool_concurrency=self.max_function_tool_concurrency,
                        ),
                    ),
